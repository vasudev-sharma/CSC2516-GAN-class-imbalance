"""
Sources: 
1. https://wandb.ai/ayush-thakur/gan-evaluation/reports/How-to-Evaluate-GANs-using-Frechet-Inception-Distance-FID---Vmlldzo0MTAxOTI
2. https://wandb.ai/ayush-thakur/keras-gan/reports/Towards-Deep-Generative-Modeling-with-W-B--Vmlldzo4MDI4Mw
3. https://arxiv.org/pdf/2009.14075.pdf (Backrpropagation through FID)
...
gen_path = 'bagan_gp_results/my_generator.h5'
generator = load_model(gen_path)

# load real images from validation set
real_imgs = np.load('x_val_covid.npy')
real_label = np.load('y_val_covid.npy')
