...
# DCGAN_GP
python scripts/GANs/DCGAN_GP.py --dataset COVID-small --user vasu --with_gan True --epochs 200 --lr 2e-2 --display_step 100 --z_dim 128 --GAN_type DCGAN_GP --batch_size 32  --im_channel 3 
