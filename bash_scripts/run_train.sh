...
python main.py --with_gan "True" --idx 0 --user "vasu" --skip_training ""  --dataset_size  10  --dataset  "COVID-small"  --fraction  0.1  --epochs  30  --data_aug  "True" --gan_data_path "/w/247/vasu/CSC2516-GAN-class-imbalance/models/COVID-small/LSGAN/generated"
...
# LSGAN
# python scripts/GANs/LSGAN.py --dataset COVID-small --user vasu --with_gan True --epochs 2 --lr 2e-3 --display_step 100 --z_dim 128 --GAN_type LSGAN --batch_size 32 --im_channel 3 --patience 30 --n_class_generate 0 --num_images_per_class 250
