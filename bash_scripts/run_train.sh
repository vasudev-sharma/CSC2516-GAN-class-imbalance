...
# LSGAN
# python scripts/GANs/LSGAN.py --dataset MNIST --user vasu --with_gan True --epochs 200 --lr 2e-3 --display_step 200 --z_dim 128 --GAN_type LSGAN --batch_size 64 --im_channel 3 --patience 30 --n_class_generate 1 --num_images_per_class 20
...
# LSGAN
# python scripts/GANs/LSGAN.py --dataset COVID-small --user vasu --with_gan True --epochs 200 --lr 2e-3 --display_step 100 --z_dim 128 --GAN_type LSGAN --batch_size 32 --im_channel 3 --patience 30 --n_class_generate 1 --num_images_per_class 20
